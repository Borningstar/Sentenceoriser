...
abstract class SectionTemplate extends ListFragment {
    Context c;
    String customSubject = "";
    ViewAnimator viewAnimator;
    ScaleGestureDetector scaleGestureDetector;
    ArrayList<SettingsRow> rows = null;
            ...
            switch (eventAction){
                case MotionEvent.ACTION_UP:
                    ...
                    if (customSubject.equals("")){
                        textView.setText(topicGenerator.generateTopic(topicType));
                    }
                    sentence = textView.getText().toString();
                    break;
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ((MainActivity)getActivity()).setCurrentPagerItem(pagePosition);
            return true;
        }
    }
